...
int main(int argc, char *argv[]) {
    ...
    fs_create("user1", "password1", session, seq++, "/dirnfwalkngwalknglkwanglwanglwanglwanlgwalgwalkwmaflwmalfmwa", 'd');

    // create a new file under the newly created directory, /dir. 
    fs_create("user1", "password1", session, seq++, "/dirnwglanglwkajglwakmglawmglwamglwamgklwamglwamglawmlgwamll", 'f');

    fs_create("user1", "password1", session, seq++, "/dirnwglanglwkajglwakmglawmglwamglwamgklwamglwamglawmlgwaml", 'f');
