...
int main(int argc, char *argv[]) {
    ...
    // error because /dir is already there
    ...
    // create a new file under the newly created directory, /dir/dir2. 
    fs_create("user1", "password1", session, seq++, "/dir/dir2/file1", 'f');

    // should be ok, since different users
    fs_create("user2", "password2", session2, seq++, "/file1", 'f');

    // user2 doesnt have a /dir/file, so invalid
    fs_writeblock("user1", "password1", session, seq++, "/dir/dir2/file1", 0, writedata);
}