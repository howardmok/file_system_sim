...
int main(int argc, char *argv[]) {
    ...
    // write to the new file with write data, should only read first 512 bytes
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 2, writedata2);

    // write to the new file with write data, should only read first 512 bytes
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 3, writedata2);

    // write to the new file with write data, should only read first 512 bytes
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 4, writedata2);

    // write to the new file with write data, should only read first 512 bytes
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 5, writedata2);

    // write to the new file with write data, should only read first 512 bytes
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 6, writedata2);

    // write to the new file with write data, should only read first 512 bytes
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 7, writedata2);

    // invalid?
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 8, writedata2);
