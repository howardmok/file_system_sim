/*
 * test makes sure we're not decrementing fs_direntry array size on a single delete 
 */
#include <iostream>
#include <cstdlib>
#include "fs_client.h"
...
int main(int argc, char *argv[]) {
    ...
    fs_create("user1", "password1", session, seq++, "/dir0/file1", 'f');
    fs_create("user1", "password1", session, seq++, "/dir0/file2", 'f');
    fs_delete("user1", "password1", session, seq++, "/dir0/file2");
}