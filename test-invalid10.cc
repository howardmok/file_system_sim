...
int main(int argc, char *argv[]) {
    ...
    fs_create("user2", "password2", session2, seq++, "/dir2", 'd');
    ...
    // should be ok, since different users
    fs_create("user2", "password2", session2, seq++, "/dir2/file", 'f');
    
    // invalid
    fs_readblock("user2", "password2", session, seq++, "/dir/file1", 0, readdata);
    
    // delete the file, invalid
